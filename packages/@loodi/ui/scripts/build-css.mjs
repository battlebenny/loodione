...
const componentFiles = ['mini-header.css', 'bottom-nav.css', 'launcher.css', 'shared-preferences.css', 'global-settings.css', 'player-qr-code.css', 'account.css', 'auth-bottom-sheet.css']
